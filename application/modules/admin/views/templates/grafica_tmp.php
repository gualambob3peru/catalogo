...
<body>
    ...
    <nav class="navTemplate fondoBlanco1" style="height: 53px;">
        <img class="mt-2 ml-3" src="static/images/logo.png" alt="" style="float:left;height: 25px;">
        <div class="ml-4 pt-2 mt-1 float-left f14 pl-3 colorRojo1 font-weight-bold"><?php echo $this->session->userdata("descripcion"); ?>: </div>
        <div class="ml-4 pt-2 mt-1 f14 float-left"><?php echo strtoupper($this->session->userdata("nombresCompletos")) ?></div>

        <img src="static/images/cerrarSesion.png" class="mt-3 mr-5 float-right" alt="" style="height:17px">
        <a href="admin/logout" class="mt-3 float-right f13 colorRojo1 pr-3">Cerrar sesión</a>
    </nav>
